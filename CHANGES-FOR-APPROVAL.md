...
**What we did.** Reproduced both trees exactly, thin English included. We are
prohibited from inventing content to fill a language gap — it would mean writing
claims and credentials about named, licensed people.

**If you say otherwise.** Commissioning English versions of the French mission,
philosophy and biographies roughly doubles the English site. It is a
writing-and-approval job for National Bank, not a build one — and worth deciding
which page you would rather a prospective client landed on.
*(C-62 · S-07 · `COMPLIANCE.md` P-16 / R-13 · INTAKE Q3)*
...
*(`COMPLIANCE.md` C-17 / C-18 / C-35 / C-36 / C-40 · R-07 / R-10 · INTAKE Q8)*
...
| D-15 | **Your `Notre firme` / `Our Firm` page says nothing about your firm.** Every sentence on it belongs to National Bank — the FBNGP/NBFWM network description, the four statistics, the parent-bank paragraph. The only thing on the page that is yours is Laurent's and David Alexandre's phone numbers and email addresses at the bottom. | We reproduced it exactly as it stands. Writing an introduction to Groupe Wolf Achard for this page would be inventing copy about a regulated business, which we do not do (P-5). | This is the page a prospective client opens to find out who they would be dealing with, and today it answers "National Bank" and stops. **A short paragraph in your own words — who the team is, who it serves — would change that page more than any design work.** It needs to be written by you and approved by NBF compliance; we cannot supply it. |
...
| 2026-08-02 | **Home page: the English page is shorter than the French one, on purpose** | Your English home page has no mission, no commitments, no philosophy, no list items and no descriptions under its four process steps. We did not write any (P-16 / INTAKE Q3). Instead the English page omits those sections entirely rather than showing empty headings, and gives the sections it does have more room and larger type. Its four process steps become a single-line rail instead of the French described rows. **Five full sections in English, seven in French; neither page shows a gap.** |
...
| 2026-08-02 | **Team page: the English page carries no biographies, on purpose** | The French team page carries two `Biographie` panels — five paragraphs of credentials for Lysane Tougas and Jean-Francois Gobeil. The English page carries none, because your English page carries none. We wrote no English versions (P-16): they are credential claims about named, licensed individuals. The English partner cards are simply shorter; there is no empty panel and no heading over absent content. **The gap itself is the finding.** |
